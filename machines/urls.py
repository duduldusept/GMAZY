...
urlpatterns = [
    ...
    path('contrats/<int:id_contrat>/supprimer/', views.supprimer_contrat, name='supprimer_contrat'),
    path('contrats/<int:id_contrat>/document/', views.telecharger_contrat_document, name='telecharger_contrat_document'),
